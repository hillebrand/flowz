...
const _NAV_ICONS = {
  ...
  progress:        `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" class="w-5 h-5"><path d="M18 20V10M12 20V4M6 20v-6"/></svg>`,
  ...
  const navHTML = `
    ...
    <nav id="nav-drawer" class="fixed top-0 left-0 h-full w-64 bg-white z-50 shadow-xl transform -translate-x-full transition-transform duration-300">
      ...
      <ul class="p-4 space-y-1">
        ...
        <li>${link('03.2-voortgang.html',           activePage==='progress',     _NAV_ICONS.progress,     'Voortgang')}</li>
